...
RUN_ATTACK_DAMAGE=20
RUN_ATTACK_WINDUP_DURATION=5
RUN_ATTACK_ACTIVE_DURATION=10
RUN_ATTACK_RECOVERY_DURATION=5
...
ENEMY_ATTACK_WINDUP=int(ATTACK_1_WINDUP_DURATION*2)
ENEMY_ATTACK_ACTIVE=int(ATTACK_1_ACTIVE_DURATION*0.5)
ENEMY_ATTACK_RECOVERY=int(ATTACK_1_RECOVERY_DURATION*2)
ENEMY_ATTACK_COOLDOWN=int(ATTACK_1_COOLDOWN*2)
